...
function bindHeader(header){
 ...
 actions.innerHTML=`<div class="pd-search-wrap"><label class="pd-site-search">${iconSearch()}<input type="search" autocomplete="off" spellcheck="false" aria-label="Search PilotDesk" aria-controls="pdSearchResults" aria-expanded="false" placeholder="Search PilotDesk"></label><div class="pd-search-results" id="pdSearchResults" role="status" hidden></div></div><a class="pd-account-link" href="/account.html" data-pd-account-link><span class="pd-account-avatar" hidden>PD</span><span class="pd-account-text">Sign in</span></a>`;
