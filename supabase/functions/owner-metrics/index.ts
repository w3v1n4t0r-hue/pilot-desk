...
Deno.serve(async(req:Request)=>{
 ...
 try{
  ...
  const [total,today,last7Days,last30Days,dailyToday,daily7,dailyTotal,perfectToday]=await Promise.all([
  ...
  return json(200,{total,today,last7Days,last30Days,dailyToday,daily7,dailyTotal,dailyActive7,perfectToday,lastAccountAt,generatedAt:now.toISOString()});
