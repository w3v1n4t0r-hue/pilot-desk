...
const required=['assets/home-command-center.css','assets/home-command-center.js','assets/context-widget.js'];
...
console.log('Homepage command-center checks passed: compact search nav, action-first hero, live context widgets, swipeable task cards, personalized tools, dense calculator catalog, and offline caching verified.');
