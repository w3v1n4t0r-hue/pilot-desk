...
const CORE=[
  ...
  '/assets/styles.css','/assets/home-command-center.css','/assets/professional-polish.css','/assets/performance.css','/assets/weather.css','/assets/wb-v2.css','/assets/planner-suite.css','/assets/route-planner.css','/assets/procedure-viewer.css','/assets/checklist-trainer.css',
  '/assets/site.js','/assets/app-bootstrap.js','/assets/home-command-center.js','/assets/context-widget.js','/assets/performance.js','/assets/tool-first-layout.js','/assets/sticky-app.js','/assets/growth-suite.js','/assets/flight-workspace.js','/assets/product-nav.js','/assets/navlog-core.js','/assets/procedures.js','/assets/route-planner.js','/assets/poh-chart-studio.js','/assets/checklist-trainer.js',
...
const NETWORK_FIRST_ASSETS=new Set([
  '/assets/app-bootstrap.js','/assets/home-command-center.js','/assets/home-command-center.css','/assets/context-widget.js','/assets/tool-first-layout.js','/assets/performance.js','/assets/sticky-app.js','/assets/growth-suite.js','/assets/weather-fixed.js','/assets/weather-extra.js','/assets/analytics.js','/assets/share-enhance.js',
