...
function bindHeader(header){
 ...
 actions.innerHTML=`<a class="pd-plans-link" href="/pricing.html">Plans</a><div class="pd-search-wrap"><label class="pd-site-search">${iconSearch()}<input type="search" autocomplete="off" spellcheck="false" aria-label="Search PilotDesk" placeholder="Search PilotDesk"><kbd class="pd-search-key" aria-hidden="true">/</kbd></label><div class="pd-search-results" role="listbox" hidden></div></div><a class="pd-account-link" href="/account.html" data-pd-account-link><span class="pd-account-avatar" hidden>PD</span><span class="pd-account-text">Sign in</span></a>`;
