...
for(const n of ['https://www.pilot-desk.com/skill-gap.html','PPL','CPL','ATP','Based on FAA sources, not a leaked test bank','FAA PAR sample questions','FAA CAX sample questions','FAA ATM sample questions','/assets/skill-gap.js'])need(page,n,'skill-gap page');
...
console.log('Pilot Skill Gap checks passed: PPL/CPL/ATP ratings, FAA sample/ACS labeling, secure grading, saved results, subject-by-subject scoring, Daily/training discovery, and SEO wiring verified.');
