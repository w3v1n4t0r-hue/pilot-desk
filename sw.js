...
const CORE=[...new Set([
  ...
  '/assets/site.js','/assets/safety.js','/assets/app-bootstrap.js','/assets/home-desk.js','/assets/navigation-core.js','/assets/global-nav.js','/assets/theme.js','/assets/features.js','/assets/calculator-ux.js','/assets/crosswind-mfd.js','/assets/pilotdesk-plus.js','/assets/experience.js','/assets/errors.js','/assets/analytics.js','/assets/update.js','/assets/ad-config.js','/assets/ads.js','/assets/share-enhance.js','/assets/inventory-data.js',
  ...GENERATED_ASSETS,
