...
const NETWORK_FIRST_ASSETS=new Set([
  ...
  '/assets/analytics.js','/assets/billing.js','/assets/pro-access.js','/assets/share-enhance.js','/assets/page-share.js','/assets/learn-step7.js','/assets/weather.css','/assets/weather-fixed.js','/assets/weather-extra.js','/assets/offline-weather.js','/assets/learn-shell.js','/assets/learn-2026.css','/assets/step6-2026.css','/assets/user-preferences.js','/assets/system-states.js','/assets/written-prep.js','/assets/written-prep.css','/assets/daily.js','/assets/daily.css','/assets/skill-gap.js','/assets/account.js','/assets/account.css'
]);
