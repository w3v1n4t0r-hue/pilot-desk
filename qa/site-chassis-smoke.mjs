...
need(footer,'footerLinks.map','Footer.astro');need(footer,'PilotDesk supplements—not replaces—current official weather, charts, NOTAMs, regulations, procedures, and approved aircraft data.','Footer.astro');
