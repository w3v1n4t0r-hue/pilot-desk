...
const NETWORK_FIRST_ASSETS=new Set([
  '/assets/app-bootstrap.js','/assets/brand.js','/assets/icon.svg','/assets/styles.css','/assets/avionics-ui.css','/assets/avionics-architecture.css','/assets/avionics-ops.css','/assets/product-clarity.css','/assets/avionics-architecture.js','/assets/avionics-command.js','/assets/flight-strip-export.js','/assets/crosswind-mfd.js','/assets/product-clarity.js','/assets/professional-polish.css','/assets/home-command-center.js','/assets/home-command-center.css','/assets/home-task-polish.css','/assets/home-avionics-final.css','/assets/context-widget.js','/assets/tool-first-layout.js','/assets/performance.js','/assets/sticky-app.js','/assets/growth-suite.js','/assets/weather-fixed.js','/assets/weather-extra.js','/assets/analytics.js','/assets/share-enhance.js',
...
async function trim(cache){const keys=await cache.keys();const runtime=keys.filter(req=>!CORE_PATHS.has(new URL(req.url).pathname));const overflow=runtime.length-MAX_RUNTIME_ENTRIES;if(overflow>0)await Promise.all(runtime.slice(0,overflow).map(req=>cache.delete(req)))}
