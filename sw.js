...
const CORE=[
  ...
  '/assets/site.js','/assets/app-bootstrap.js','/assets/performance.js','/assets/tool-first-layout.js','/assets/sticky-app.js','/assets/growth-suite.js','/assets/flight-workspace.js','/assets/product-nav.js','/assets/navlog-core.js','/assets/procedures.js','/assets/route-planner.js','/assets/poh-chart-studio.js','/assets/checklist-trainer.js',
...
const NETWORK_FIRST_ASSETS=new Set([
  '/assets/app-bootstrap.js','/assets/tool-first-layout.js','/assets/performance.js','/assets/sticky-app.js','/assets/growth-suite.js','/assets/weather-fixed.js','/assets/weather-extra.js','/assets/analytics.js','/assets/share-enhance.js',
