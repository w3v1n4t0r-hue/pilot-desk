...
const routes=[
 ...
 ['/learn/checkride-lab/','Checkride Lab'],
 ['/learn/study-plan/','Study Plan'],
 ['/learn/coverage/','ACS Coverage'],
...
function init(){
 ...
 const hero=main.querySelector('.safety-strip,.pd-prep-hero,.pd-gap-hero,.pd-page-hero,.pd-flight-hero,.calc-hero')||main.querySelector('h1')||main.firstElementChild;
