...
const CORE=[...new Set([
  ...
  '/assets/styles.css','/assets/styles-legacy.css','/assets/hub.css','/assets/experience.css','/assets/consistency.css','/assets/visual-system.css','/assets/pilotdesk-navigation-2026.css','/assets/calculators-2026.css','/assets/planning-2026.css','/assets/learn-2026.css','/assets/system-states.css','/assets/design-tokens.css',
...
const NETWORK_FIRST_ASSETS=new Set([
  ...
  '/assets/analytics.js','/assets/share-enhance.js','/assets/page-share.js','/assets/weather.css','/assets/weather-fixed.js','/assets/weather-extra.js','/assets/offline-weather.js','/assets/learn-shell.js','/assets/learn-2026.css','/assets/system-states.js','/assets/system-states.css','/assets/written-prep.js','/assets/written-prep.css','/assets/daily.js','/assets/daily.css','/assets/skill-gap.js','/assets/account.js','/assets/account.css','/assets/pricing-billing.js','/assets/pricing.css'
]);
