...
console.log(`Written Prep checks passed: ${questionCount} FAA-grounded practice items across PPL/IRA/CPL/CFI/CFII/ATP, account-gated secure grading, adaptive review, practice exams, saved progress, owner metrics, and site discovery verified.`);
