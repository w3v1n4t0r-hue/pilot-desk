...
const sw=read('sw.js');ok(sw.includes("pilotdesk-v31")&&sw.includes("'/assets/growth-suite.js'")&&sw.includes("'/assets/home-task-polish.css'"),'service worker not updated for growth suite and homepage refresh');
