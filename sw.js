...
const CORE=[...new Set([
  ...
  '/assets/styles.css','/assets/styles-legacy.css','/assets/hub.css','/assets/experience.css','/assets/consistency.css','/assets/visual-system.css','/assets/pilotdesk-navigation-2026.css','/assets/calculators-2026.css','/assets/planning-2026.css','/assets/learn-2026.css','/assets/final-shell-2026.css','/assets/design-tokens.css',
  '/assets/site.js','/assets/safety.js','/assets/app-bootstrap.js','/assets/product-states.js','/assets/calculation-account.js','/assets/home-desk.js','/assets/home-desk.css','/assets/navigation-core.js','/assets/global-nav.js','/assets/theme.js','/assets/features.js','/assets/calculator-ux.js','/assets/crosswind-mfd.js','/assets/pilotdesk-plus.js','/assets/experience.js','/assets/errors.js','/assets/analytics.js','/assets/update.js','/assets/ad-config.js','/assets/ads.js','/assets/share-enhance.js','/assets/inventory-data.js',
  ...GENERATED_ASSETS,
...
const NETWORK_FIRST_ASSETS=new Set([
  ...
  '/assets/styles.css','/assets/styles-legacy.css','/assets/hub.css','/assets/experience.css','/assets/consistency.css','/assets/pilotdesk-navigation-2026.css','/assets/calculators-2026.css','/assets/planning-2026.css','/assets/learn-2026.css','/assets/final-shell-2026.css','/assets/design-tokens.css',
  '/assets/analytics.js','/assets/share-enhance.js','/assets/page-share.js','/assets/product-states.js','/assets/final-shell-2026.css','/assets/account.js','/assets/account.css','/assets/pricing-billing.js','/assets/pricing.css','/assets/weather.css','/assets/weather-fixed.js','/assets/weather-extra.js','/assets/offline-weather.js','/assets/learn-shell.js','/assets/learn-2026.css','/assets/written-prep.js','/assets/written-prep.css','/assets/daily.js','/assets/daily.css','/assets/skill-gap.js'
]);
