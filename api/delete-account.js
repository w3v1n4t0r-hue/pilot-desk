...
module.exports=async function handler(req,res){
  ...
  const base=cleanBase(process.env.SUPABASE_URL),anon=String(process.env.SUPABASE_ANON_KEY||'').trim(),service=String(process.env.SUPABASE_SERVICE_ROLE_KEY||'').trim(),token=bearer(req);
