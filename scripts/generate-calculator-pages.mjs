...
const seoDescriptionBySlug={
  ...
  'isa-temperature':'Calculate ISA temperature by altitude in feet. Free pilot ISA temperature calculator with the standard-atmosphere lapse rate, formula and training reference.',
