...
function loadBoot(){if(document.querySelector('script[src="/assets/boot.js"]'))return;const s=document.createElement('script');s.src='/assets/boot.js';s.async=false;document.head.appendChild(s)}
function modal(){
...
function addProductRow(){
  ...
  row.innerHTML='<a href="/airport.html">Airport Search</a><a href="/route-planner.html">Route Planner</a><a href="/flight-planning-workspace.html">Planning Workspace</a><a href="/flights.html">Saved Flights</a><a href="/flight-brief.html">Flight Brief</a><a href="/aircraft.html">My Hangar</a><button class="pd-install-button" type="button">Install PilotDesk</button>';
