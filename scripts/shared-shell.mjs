...
export function sharedShell(html){
 ...
 const footer=`<footer><div><b>PilotDesk</b><p>Planning and training tools for pilots.</p></div><div class="footer-links">${footerLinks.map(([u,t])=>`<a href="${u}">${esc(t)}</a>`).join('')}</div><p class="fine">PilotDesk supplements—not replaces—current official weather, charts, NOTAMs, regulations, procedures, and approved aircraft data.</p></footer>`;
