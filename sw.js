...
const NETWORK_FIRST_ASSETS=new Set([
  '/assets/app-bootstrap.js','/assets/home-command-center.js','/assets/context-widget.js','/assets/tool-first-layout.js','/assets/performance.js','/assets/sticky-app.js','/assets/growth-suite.js','/assets/weather-fixed.js','/assets/weather-extra.js','/assets/analytics.js','/assets/share-enhance.js',
